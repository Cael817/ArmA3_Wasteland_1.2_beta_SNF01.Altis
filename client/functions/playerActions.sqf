...
[
	...
	//["<img image='client\icons\money.paa'/> Salvage Rabbit", "client\actions\pickupMoney.sqf", [], 1, false, false, "", "cursorTarget isKindOf 'Rabbit_F' && player distance cursorTarget < 5"],
	["<img image='client\icons\money.paa'/> Gather Meat", "gatherfood.sqf", [], 1, false, false, "", "vehicle player == player && {alive _x} count (player nearEntities ['Animal', 2]) > 0"],
	["<img image='client\icons\money.paa'/> Gather Meat 2", "gatherfood.sqf", [], 1, false, false, "", "vehicle player == player && cursorTarget isKindOf 'Animal' && !alive cursorTarget && (_target distance cursorTarget) < 2"],
