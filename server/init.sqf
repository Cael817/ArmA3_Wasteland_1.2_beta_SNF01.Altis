...
call compile preprocessFileLineNumbers "mapconfig\setupTownMarkers.sqf";
call compile preprocessFileLineNumbers "mapconfig\setupStoreOwners.sqf";
call compile preprocessFileLineNumbers "mapconfig\setupMissionMarkers.sqf";
call compile preprocessFileLineNumbers "mapconfig\setupVehicleMarkers.sqf";
call compile preprocessFileLineNumbers "mapconfig\SetupTerritoryMarkers.sqf";
